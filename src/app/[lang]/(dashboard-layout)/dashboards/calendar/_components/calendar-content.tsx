...
const eventColors: Record<CategoryType, string> = {
  کلاس‌ها: "hsl(var(--chart-1))",
  "تمرین خصوصی": "hsl(var(--chart-2))",
  عضویت: "hsl(var(--chart-3))",
  رویدادها: "hsl(var(--chart-4))",
  نگهداری: "hsl(var(--chart-5))",
  متفرقه: "hsl(var(--primary))",
}
...
export function CalendarContent() {
  ...
  return (
    <FullCalendar
      // dayCellContent={(arg) => <span>{dayjs(arg.date).format("D")}</span>}
      ref={calendarRef}
      direction={direction}
