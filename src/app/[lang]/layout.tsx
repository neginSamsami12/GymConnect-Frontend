import { Lato, Noto_Sans_Old_Persian } from "next/font/google"
...
const sansFont = Noto_Sans_Old_Persian({
  subsets: ["old-persian"],
  weight: ["400"],
  style: ["normal"],
  variable: "--font-cairo",
...
export default async function RootLayout(props: {
  ...
  return (
    <html lang={params.lang} dir={direction} suppressHydrationWarning>
      <body
        className={cn(
          "[&:lang(en)]:font-lato [&:lang(fa)]:font-cairo", // Set font styles based on the language
          ...
          sansFont.variable // Include Cairo font variable
        )}
      >
